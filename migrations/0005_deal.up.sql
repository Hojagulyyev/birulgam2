CREATE TABLE IF NOT EXISTS deal (
    ...
    company_id BIGINT DEFAULT NULL REFERENCES company(id) ON DELETE CASCADE,
    store_id BIGINT DEFAULT NULL REFERENCES store(id) ON DELETE CASCADE,
    ...
    store_code VARCHAR(2) DEFAULT NULL,
    code_number INTEGER DEFAULT NULL,
